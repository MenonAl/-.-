// Max.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
    ...
    for (int k = 1; k <= Tests;k++)
    {
        ...
        uniform_int_distribution<> dist_int2(-1000, -1);
        ...
        uniform_int_distribution<> dist_int4(-100000, -1);
        double random_int;
        ...
        if (k < 10)
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Max\\Max\\0" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Max\\Max\\0" + std::to_string(k) + ".a");
        }
        else
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Max\\Max\\" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Max\\Max\\" + std::to_string(k) + ".a");
        }
        for (int i = 0; i < n;i++)
        {
            if (k < 3) {
        ...
        int a = input[0];
        int b = input[1];
        int c = sqrt((input[0] - input[1]) * (input[0] - input[1]));
        ans = (a + b + c)/2;
        out1.close();
        std::cout << ans<<'\n';
