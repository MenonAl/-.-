// Next even.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
    ...
    for (int k = 1; k <= Tests;k++)
    {
        ...
        if (k < 10)
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Next even\\Next even\\0" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Next even\\Next even\\0" + std::to_string(k) + ".a");
        }
        else
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Next even\\Next even\\" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Next even\\Next even\\" + std::to_string(k) + ".a");
        }
        for (int i = 0; i < n;i++)
        {
            if (k < 3) {
