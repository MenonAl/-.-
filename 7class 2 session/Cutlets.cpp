// Cutlets.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
    ...
    for (int k = 1; k <= Tests;k++)
    {
        ...
        uniform_int_distribution<> dist_int2(0, 5000);
        ...
        uniform_int_distribution<> dist_int4(0, 32000);
        double random_int;
        ...
        if (k < 10)
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Cutlets\\Cutlets\\0" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Cutlets\\Cutlets\\0" + std::to_string(k) + ".a");
        }
        else
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Cutlets\\Cutlets\\" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Cutlets\\Cutlets\\" + std::to_string(k) + ".a");
        }
        for (int i = 0; i < n;i++)
        {
            if (k < 3) {
        ...
        ans = (ceil(input[2] / input[0]) * 2 * input[1]);
        std::cout << ans << "\n";
        out2 << ans << '\n';
