...
int main()
{
    ...
    for (int k = 1; k <= Tests;k++)
    {
        random_device rd;
        mt19937 gen(rd());
        uniform_int_distribution<> dist_int_samples(1, 9);
        uniform_int_distribution<> dist_int1(0, 1000);
        uniform_int_distribution<> dist_int2(-1000, 100);
        uniform_int_distribution<> dist_int3(-100, 1000);
        double from = -1.235;
        double to = 157.456;
        ...
        uniform_int_distribution<> dist_int4(-1000, 10000);
        double random_int;
        ...
        if (k < 10)
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Chocolate\\Chocolate\\0" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Chocolate\\Chocolate\\0" + std::to_string(k) + ".a");
        }
        else
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Chocolate\\Chocolate\\" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Chocolate\\Chocolate\\" + std::to_string(k) + ".a");
        }
        for (int i = 0; i < n;i++)
        {
            if (k < 3) {
