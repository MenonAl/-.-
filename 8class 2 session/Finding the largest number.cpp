// Finding the largest number.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int Finding_the_largest_number(const std::vector <int> input)
{
    int ans1 = input[0];
...
int main()
{
    ...
    for (int k = 1; k <= Tests;k++)
    {
        ...
        uniform_int_distribution<> dist_int2(1, 100000);
        uniform_int_distribution<> dist_int3(-100000, 100000);
        ...
        if (k < 10)
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Finding the largest number\\Finding the largest number\\0" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Finding the largest number\\Finding the largest number\\0" + std::to_string(k) + ".a");
        }
        else
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Finding the largest number\\Finding the largest number\\" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Finding the largest number\\Finding the largest number\\" + std::to_string(k) + ".a");
        }
        for (int i = 0; i < n;i++)
        {
            if (k < 3) {
        ...
        std::cout << Finding_the_largest_number(input) << '\n' << '\n';
        out2 << Finding_the_largest_number(input) << '\n';
        out2.close();
    }
}
