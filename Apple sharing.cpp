// Apple sharing.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
#include <fstream>
#include <random>
#include <iostream>
...
int main()
{
    ...
    for (int k = 1; k <= Tests;k++)
    {
        ...
        uniform_int_distribution<> dist_int4(-5000, 20000);
        double random_int;
        ...
        if (k < 10)
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Apple sharing\\Apple sharing\\0" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Apple sharing\\Apple sharing\\0" + std::to_string(k) + ".a");
        }
        else
        {
            out1.open("C:\\Users\\menon\\source\\repos\\Apple sharing\\Apple sharing\\" + std::to_string(k));
            out2.open("C:\\Users\\menon\\source\\repos\\Apple sharing\\Apple sharing\\" + std::to_string(k) + ".a");
        }
        for (int i = 0; i < n;i++)
        {
            if (k < 3) {
        ...
        out1.close();
        out2.open("C:\\Users\\menon\\source\\repos\\Apple sharing\\Apple sharing\\0" + std::to_string(k) + ".a");
        if (typeid(input[0]).name() == "Double") { std::cout << " Wrong input"; }
